...
## http://127.0.0.1:5858/global-settings/{id} [GET]

Get global settings by id, but currently id doesn't matter. E.g.: GET - http://127.0.0.1:5858/global-settings/1

## http://127.0.0.1:5858/global-settings/{id} [POST]

Post global settings, handler will do nothing except return 200. E.g.: POST - http://127.0.0.1:5858/global-settings/1

## http://127.0.0.1:5858/global-settings/{id} [PUT]
